...
<div class="mobile-dropdown" id="mobileDropdown">
    ...
    <nav class="mobile-nav">
        <a href="admin_dashboard.php" class="mobile-nav-link<?php echo nav_active('admin_dashboard.php', $current_page); ?>">
        ...
        <a href="admin_reports.php" class="mobile-nav-link<?php echo nav_active('admin_reports.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="admin_trust_management.php" class="mobile-nav-link<?php echo nav_active('admin_trust_management.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="route_status.php" class="mobile-nav-link<?php echo nav_active('route_status.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="manage_routes.php" class="mobile-nav-link<?php echo nav_active('manage_routes.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="heatmap.php" class="mobile-nav-link<?php echo nav_active('heatmap.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="user_management.php" class="mobile-nav-link<?php echo nav_active('user_management.php', $current_page); ?>">
            <svg class="nav-ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
