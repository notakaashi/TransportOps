        ...
        <div class="card">
            <div class="card-header">
                ...
                <div style="display:flex;align-items:center;gap:0.75rem;">
                    <button onclick="exportToPDF()" class="abtn abtn-primary abtn-sm">
                        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7 21h10a2 2 0 002-2V9a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        Export to PDF
                    </button>
                </div>
...
// ── PDF Export Function ─────────────────────────── */
    function exportToPDF() {
        ...
        const analyticsData = {
            ...
            delayRate: totalReports > 0 ? Math.round((activeDelays / totalReports) * 100) : 0,
            reportsPerUser: totalUsers > 0 ? Math.round(totalReports / totalUsers) : 0,
            reportsPerRoute: totalRoutes > 0 ? Math.round(totalReports / totalRoutes) : 0,
            ...
            <body>
                ...
                <div class="metrics-grid">
                    <div class="metric-box">
                        ...
                        <div class="metric-value">${data.totalReports.toLocaleString()}</div>
                        <div class="metric-subtitle">All time submissions</div>
                    </div>
                    <div class="metric-box">
                        <div class="metric-title">Active Delays</div>
                        <div class="metric-value">${data.activeDelays.toLocaleString()}</div>
                        <div class="metric-subtitle">Reports with delay reason</div>
                    </div>
                    <div class="metric-box">
                        <div class="metric-title">Total Users</div>
                        <div class="metric-value">${data.totalUsers.toLocaleString()}</div>
                        <div class="metric-subtitle">Registered accounts</div>
                    </div>
                    <div class="metric-box">
                        <div class="metric-title">Active Routes</div>
                        <div class="metric-value">${data.totalRoutes.toLocaleString()}</div>
                ...
                <div class="chart-section">
                    ...
                    <div class="chart-data">
                        <div class="chart-item">
                            ...
                            <strong>${data.delayRate}%</strong>
                        </div>
                        <div class="chart-item">
                            <span>Reports per User</span>
                            <strong>${data.reportsPerUser}</strong>
                        </div>
                        <div class="chart-item">
                            <span>Reports per Route</span>
                            <strong>${data.reportsPerRoute}</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="chart-section">
                    ...
                    <div class="chart-data">
                        ${data.delayTrends.map(trend => `
                            <div class="chart-item">
                                <span>${trend.x}</span>
                                <strong>${trend.y} reports</strong>
                            </div>
                        `).join('')}
                    </div>
                </div>
